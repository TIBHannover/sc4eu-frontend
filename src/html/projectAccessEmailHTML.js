                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <h2 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">
                            Request to grant permission to join Project "${projectName}"</h2>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellPadding="0" cellSpacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">Hello ${ProjectAdminName},</p>
                        <p>${emailContent}</p>
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <ol>
                            ...
                            <li>Find the project you want to add and click on the "Project Members" dropdown located in the "Project Members" column.</li>
                            <li>Click on the "Add Member" icon (a person with a plus sign) located on the right-hand side.</li>
                            <li>Enter ${SenderEmail} in the designated field and click "Submit".</li>
                        </ol>
                    </td>
                </tr>
