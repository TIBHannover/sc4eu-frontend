module.exports = {
    oauth2: {
        ...
        callbackURL: `${process.env.CALLBACK_URL}/vocab/auth/oauth2/callback`,
        scope: ['profile', 'email'],
        state: true
    },
    gitlab: {
        ...
        callbackURL: `${process.env.CALLBACK_URL}/vocab/auth/gitlab/callback`
    },
    github: {
        clientID: process.env.GITHUB_CLIENT_ID_FOR_LOGIN,
        clientSecret: process.env.GITHUB_CLIENT_SECRET_FOR_LOGIN,
        callbackURL: `${process.env.CALLBACK_URL}/vocab/auth/github/callback`
    },
    sap: {
        ...
        callbackURL: `${process.env.CALLBACK_URL}/vocab/auth/sap/callback`,
        scope: ['openid', 'email', 'profile']
    },
    google: {
        clientID: process.env.GOOGLE_CLIENT_ID_FOR_LOGIN,
        clientSecret: process.env.GOOGLE_CLIENT_SECRET_FOR_LOGIN,
        callbackURL: `${process.env.CALLBACK_URL}/vocab/auth/google/callback`,
        scope: ['profile', 'email']
    }
};
