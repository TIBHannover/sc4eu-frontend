            ...
            <table border="0" cellPadding="0" cellSpacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <h2 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Reset
                            Your Password</h2>
                    </td>
                </tr>
            </table>
            ...
            <table border="0" cellPadding="0" cellSpacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">Thanks,<br> VDST Team</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" bgcolor="#e9ecef"
                        ...
                        <p style="margin: 0;">You received this email because we received a request for reset password
                            for your account. If you didn't request for reset password you can safely delete this email.</p>
                    </td>
                </tr>
